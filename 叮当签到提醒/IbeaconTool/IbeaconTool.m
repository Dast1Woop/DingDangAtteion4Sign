...
- (void)locationManager:(CLLocationManager *)manager
    ...
    [iConsole info:@"解密ornot，并排序后--(数组共%zd个beaconModel)",
...
{
    return @[ @10064, @10199, @10179, @10105, @10192, @10191];
}
...
- (void)logBeaconModelsArr:(NSArray *)arr {
    for (int i = 0; i < arr.count; ++i) {
        ...
        [iConsole info:@"major = %@, minor = %@, rssi = %zd, proximity "
         @"= %zd",
         bm.xmajor, bm.xminor, bm.xrssi,
         bm.xproximity ];
    }
}
